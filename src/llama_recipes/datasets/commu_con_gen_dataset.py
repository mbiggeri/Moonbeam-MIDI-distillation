...
class Commu_Con_Gen_Datasets(Dataset):
    ...
    def __getitem__(self, index):
        ...
        encoded_tokens = self.tokenizer.encode_series_con_gen_commu(raw_tokens, raw_tokens_chord, metadata_tokens = metadata_id)  #meta_data_tokens,<SOC> chords, <EOC>, <SOS> music_seq, <EOS>              
